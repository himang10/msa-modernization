...
import com.skcc.mongodb.exam06.entity.Relative;
import com.skcc.mongodb.exam06.repository.ContactRepository;
 ...
 */
@Service
public class ContactRepositoryIntegrationService {

	@Autowired QueryByExampleUserRepository userRepository;
...
//	}
	...
	public long countByConcreteSubtypeExample() {
	...
	public Iterator<Relative> findAllRelativesBySimpleExample() {

		Example<Relative> example = Example.of(new Relative(".*", null, null), //
				matching().withStringMatcher(StringMatcher.REGEX));

		return contactRepository.findAll(example).iterator();
