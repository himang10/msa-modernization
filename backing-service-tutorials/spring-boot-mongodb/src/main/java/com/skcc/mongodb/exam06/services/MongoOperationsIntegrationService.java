...
/**
 * Integration test showing the usage of MongoDB Query-by-Example support
...
@Service
public class MongoOperationsIntegrationService {
...
//	}
	...
	public List<Person> ignoreNullProperties() {
	...
	public List<Person> substringMatching() {

		Example<Person> example = Example.of(new Person("er", null, null), matching().//
				withStringMatcher(StringMatcher.ENDING));

		return operations.find(query(byExample(example)), Person.class);

		// assertThat(operations.find(query(byExample(example)), Person.class),
	...
	public List<Person> regexMatching() {
	...
	public List<Person> matchStartingStringsIgnoreCase() {
	...
	public List<Person> configuringMatchersUsingLambdas() {
	...
	public List<Person> valueTransformer() {
